            ...
            <form method="post" enctype="multipart/form-data"
                ...
                <div class="row">
                    <div class="form-group col-sm-12 col-md-6 mb-3">
                        ...
                        <input class="form-control" id="vehicle_year" name="vehicle_year" value="{{ isset($item) ? $item->vehicle_year : old('vehicle_year') }}" type="text" autocomplete="off" />
                    ...
                    <div class="form-group col-sm-12 col-md-6 mb-3">
                        ...
                        <input class="form-control" id="kilometers" name="kilometers" value="{{ isset($item) ? $item->kilometers : old('kilometers') }}" type="text" autocomplete="off" />
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 col-md-6 mb-3">
                        ...
                        <select class="form-select" id="type" name="type">
                            ...
                            <option @if(isset($item) && $item->type == "Novo" || isset($item) && $item->type == old('type')) selected @endif
                                >Novo</option>
                            <option @if(isset($item) && $item->type == "Usado" || isset($item) && $item->type == old('type')) selected @endif
                                >Usado</option>
                        </select>
                ...
                <div class="row">
                    <div class="form-group col-sm-12 col-md-4 mb-3">
                        ...
                        <input class="form-control" id="price" name="price" value="{{ isset($item) ? $item->price : old('price') }}" type="text" autocomplete="off" />
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-3">
                        ...
                        <input class="form-control" id="image" name="image" value="{{ isset($item) ? $item->image : old('image') }}" type="file" autocomplete="off" />
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 col-md-4 mb-3">
                        <label for="contact_phone">Contato do Vendedor</label>
